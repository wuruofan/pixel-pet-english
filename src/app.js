    ...
    dragon: { stage: { 0: 'cat-egg-v2', 1: 'dragon-kid-v2', 2: 'dragon-kid-v2', 3: 'dragon-adult-v2' },
           expr: { idle:     { 0: ['cat-egg-v2-idle-0','cat-egg-v2-idle-1'],
                   ...
                   excited:  { 0: ['cat-egg-v2-excited-0','cat-egg-v2-excited-1','cat-egg-v2-excited-2'],
                                ...
                                2: ['dragon-kid-v2-excited-0','dragon-kid-v2-excited-1','dragon-kid-v2-excited-2'],
