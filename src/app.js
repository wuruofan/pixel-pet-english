  ...
  var PET_FRAMES = {
    ...
    fox: { stage: { 0: 'fox-egg-v2', 1: 'fox-kid-v2', 2: 'fox-teen-v2', 3: 'fox-adult-v2' },
           expr: { idle:     { 0: ['fox-egg-v2-idle-0','fox-egg-v2-idle-1'],
                   ...
                   sleep:    { 0: ['fox-egg-v2-sleep-0','fox-egg-v2-sleep-1'],
                   ...
                   excited:  { 0: ['fox-egg-v2-excited-0','fox-egg-v2-excited-1','fox-egg-v2-excited-2'],
