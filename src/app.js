...
(function () {
  ...
  */
  ...
  /* 蛋斑点坐标（相对于 29×44 蛋帧，内容 y=4-39）。斑点不在 PNG 里，drawPet 按当前宠物主色
     运行时叠加，这样一套蛋帧通用、斑点颜色可随宠物类型替换。6个5x5大圆形斑点(耀西蛋风格)，
     分布在左上/右上/左中/右中/左下/右下，避开脸部(眼/腮红/嘴)。 */
  var EGG_SPOTS = [
    [6,7],[22,7],
    [5,8],[6,8],[7,8],[21,8],[22,8],[23,8],
    [4,9],[5,9],[6,9],[7,9],[8,9],[20,9],[21,9],[22,9],[23,9],[24,9],
    [5,10],[6,10],[7,10],[21,10],[22,10],[23,10],
    [6,11],[22,11],
    [4,22],[24,22],
    [3,23],[4,23],[5,23],[23,23],[24,23],[25,23],
    [2,24],[3,24],[4,24],[5,24],[6,24],[22,24],[23,24],[24,24],[25,24],[26,24],
    [3,25],[4,25],[5,25],[23,25],[24,25],[25,25],
    [4,26],[24,26],
    [8,31],[20,31],
    [7,32],[8,32],[9,32],[19,32],[20,32],[21,32],
    [6,33],[7,33],[8,33],[9,33],[10,33],[18,33],[19,33],[20,33],[21,33],[22,33],
    [7,34],[8,34],[9,34],[19,34],[20,34],[21,34],
    [8,35],[20,35]
  ];
