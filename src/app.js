...
(function () {
  ...
  */
  ...
  var PET_FRAMES = {
    ...
    fox: { stage: { 1: 'fox-kid-v2', 2: 'fox-kid-v2', 3: 'fox-adult-v2' },
           expr: { idle:     { 1: ['fox-kid-v2-idle-0','fox-kid-v2-idle-1'],
                                2: ['fox-kid-v2-idle-0','fox-kid-v2-idle-1'],
                                3: ['fox-adult-v2-idle-0','fox-adult-v2-idle-1'] },
                   blink:    { 1: ['fox-kid-v2-blink'], 2: ['fox-kid-v2-blink'], 3: ['fox-adult-v2-blink'] },
                   eat:      { 1: ['fox-kid-v2-eat-0','fox-kid-v2-eat-1','fox-kid-v2-eat-2'],
                                2: ['fox-kid-v2-eat-0','fox-kid-v2-eat-1','fox-kid-v2-eat-2'],
                                3: ['fox-adult-v2-eat-0','fox-adult-v2-eat-1','fox-adult-v2-eat-2'] },
                   sleep:    { 1: ['fox-kid-v2-sleep-0','fox-kid-v2-sleep-1'],
                                2: ['fox-kid-v2-sleep-0','fox-kid-v2-sleep-1'],
                                3: ['fox-adult-v2-sleep-0','fox-adult-v2-sleep-1'] },
                   happy:    { 1: ['fox-kid-v2-happy-0','fox-kid-v2-happy-1','fox-kid-v2-happy-2'],
                                2: ['fox-kid-v2-happy-0','fox-kid-v2-happy-1','fox-kid-v2-happy-2'],
                                3: ['fox-adult-v2-happy-0','fox-adult-v2-happy-1','fox-adult-v2-happy-2'] },
                   excited:  { 1: ['fox-kid-v2-excited-0','fox-kid-v2-excited-1','fox-kid-v2-excited-2'],
                                2: ['fox-kid-v2-excited-0','fox-kid-v2-excited-1','fox-kid-v2-excited-2'],
                                3: ['fox-adult-v2-excited-0','fox-adult-v2-excited-1','fox-adult-v2-excited-2'] },
                   big:      { 1: ['fox-kid-v2-excited-0','fox-kid-v2-excited-1','fox-kid-v2-excited-2'],
                                2: ['fox-kid-v2-excited-0','fox-kid-v2-excited-1','fox-kid-v2-excited-2'],
                                3: ['fox-adult-v2-excited-0','fox-adult-v2-excited-1','fox-adult-v2-excited-2'] },
                   droopy:   { 1: ['fox-kid-v2-droopy'], 2: ['fox-kid-v2-droopy'], 3: ['fox-adult-v2-droopy'] },
                   sad:      { 1: ['fox-kid-v2-sad-0','fox-kid-v2-sad-1'],
                                2: ['fox-kid-v2-sad-0','fox-kid-v2-sad-1'],
                                3: ['fox-adult-v2-sad-0','fox-adult-v2-sad-1'] },
                   wash:     { 1: ['fox-kid-v2-wash-0','fox-kid-v2-wash-1'],
                                2: ['fox-kid-v2-wash-0','fox-kid-v2-wash-1'],
                                3: ['fox-adult-v2-wash-0','fox-adult-v2-wash-1'] },
                   grunt:    { 1: ['fox-kid-v2-grunt-0','fox-kid-v2-grunt-1'],
                                2: ['fox-kid-v2-grunt-0','fox-kid-v2-grunt-1'],
                                3: ['fox-adult-v2-grunt-0','fox-adult-v2-grunt-1'] } },
           walk: { 1: 'fox-kid-v2-walk-', 2: 'fox-kid-v2-walk-', 3: 'fox-adult-v2-walk-' } }
  };
  /* 蛋斑点坐标（相对于 29×36 蛋帧内容）。斑点不在 PNG 里，drawPet 按当前宠物主色
     运行时叠加，这样一套蛋帧通用、斑点颜色可随宠物类型替换。位置避开脸部（眼/腮红/嘴）。 */
  var EGG_SPOTS = [
    [5,6],[6,6],[7,6], [5,7],[6,7],[7,7],[8,7], [6,8],[7,8],
    [20,6],[21,6],[22,6], [19,7],[20,7],[21,7],[22,7], [20,8],[21,8],
    [3,26],[4,26],[5,26], [3,27],[4,27],[5,27],[6,27], [4,28],[5,28],
    [19,26],[20,26],[21,26],[22,26], [18,27],[19,27],[20,27],[21,27],[22,27],
    [19,28],[20,28],[21,28], [20,29],[21,29],
    [13,31],[14,31],[15,31]
  ];
